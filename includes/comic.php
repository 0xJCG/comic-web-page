...
<?php
	...
	if ($prev == NULL AND $next != NULL)
		print "\t\t\t\t" . '<a href="index.php?comic=' . $next . '">Siguiente &gt;</a> | <a href="index.php?new">Nuevo &gt;&gt;</a></p>' . "\n"; // If we are showing the first comic, we only have to show the next and the newest links.
	elseif ($next == NULL AND $prev != NULL)
		print "\t\t\t\t" . '<a href="index.php?first">&lt;&lt; Primero</a> | <a href="index.php?comic=' .  $prev . '">&lt; Anterior</a></p>'. "\n"; // If we are showing the last comic, we only have to show the previoua and the oldest links.
	elseif ($next == NULL AND $prev == NULL)
		print "\t\t\t\t" . '</p>' . "\n"; // If we are showing the only comic, we don't show any links.
	else
		print "\t\t\t\t" . '<a href="index.php?first">&lt;&lt; Primero</a> | <a href="index.php?comic=' . $prev . '">&lt; Anterior</a> | <a href="index.php?comic=' .  $next . '">Siguiente &gt;</a> | <a href="index.php?new">Nuevo &gt;&gt;</a></p>' . "\n";
